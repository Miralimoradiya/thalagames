...
export default function Rachelholmesfinddifferences() {
    ...
    <div>
      <div className="bg-[#010127]">
        ...
        <div className="w-[380px] mx-auto mt-28 mb-56">
          <div className="px-2">
            <img
              src={restofthegames.rachelholmesfinddifferences}
              alt="game"
            ...
            <Link to="https://thalagames.com/game/rachel-holmes-find-differences/play">
              <div
