...
export default function Blockbusteradventurespuzzle() {
    ...
    <div>
      <div className="bg-[#010127]">
        ...
        <div className="w-[380px] mx-auto mt-28 mb-56">
          <div className="px-2">
            <img
              src={restofthegames.blockbusteradventurespuzzle}
              alt="game"
            ...
            <Link to="https://thalagames.com/game/blockbuster-adventures-puzzle/play">
              <div
