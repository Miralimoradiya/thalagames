...
export default function Liquidpuzzlesortthecolors() {
    ...
    <div>
      <div className="bg-[#010127]">
        ...
        <div className="w-[380px] mx-auto mt-28 mb-56">
          <div className="px-2">
            <img
              src={restofthegames.liquidpuzzlesortthecolors}
              alt="game"
              className="w-[200px] m-auto mb-2"
            />
            <h1 className="text-center text-[#fff] text-2xl">
            Liquid puzzle: sort the colors
            </h1>
            <Link to="https://thalagames.com/game/liquid-puzzle-sort-the-colors/play">
              <div
