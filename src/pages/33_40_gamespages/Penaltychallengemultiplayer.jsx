...
export default function Penaltychallengemultiplayer() {
    ...
    <div>
      <div className="bg-[#010127]">
        ...
        <div className="w-[380px] mx-auto mt-28 mb-56">
          <div className="px-2">
            <img
              src={assets_33to40.penaltychallengemultiplayer}
              alt="game"
            ...
            <Link to="https://thalagames.com/game/penalty-challenge-multiplayer/play">
              <div
