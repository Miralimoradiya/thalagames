...
export default function Candyriddlesfreematch3puzzle() {
    ...
    <div>
      <div className="bg-[#010127]">
        ...
        <div className="w-[380px] mx-auto mt-28 mb-56">
          <div className="px-2">
            <img
              src={assets_33to40.candyriddlesfreematch3puzzle}
              alt="game"
            ...
            <Link to="https://thalagames.com/game/candy-riddles-free-match-3-puzzle/play">
              <div
