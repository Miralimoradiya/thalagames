...
export default function Bricksbreakerdeluxecrusher() {
    ...
    <div>
      <div className="bg-[#010127]">
        ...
        <div className="w-[380px] mx-auto mt-28 mb-56">
          <div className="px-2">
            <img
              src={assets_25to32.bricksbreakerdeluxecrusher}
              alt="game"
            ...
            <Link to="https://thalagames.com/game/bricks-breaker-deluxe-crusher/play">
              <div
