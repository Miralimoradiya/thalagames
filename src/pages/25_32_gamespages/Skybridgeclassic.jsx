...
export default function Skybridgeclassic() {
    ...
    <div>
      <div className="bg-[#010127]">
        ...
        <div className="w-[380px] mx-auto mt-28 mb-56">
          <div className="px-2">
            <img
              src={assets_25to32.skybridgeclassic}
              alt="game"
            ...
            <Link to="https://cdn.ludigames.com/microsoft/start-skyBridge/09-cdn/h5/skyBridgeFree/?utm_source=gameloft&utm_medium=bookmark&utm_campaign=IFRAME">
              <div
