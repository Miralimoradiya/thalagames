...
export default function Candyworldmatch3mania() {
    ...
    <div>
      <div className="bg-[#010127]">
        ...
        <div className="w-[380px] mx-auto mt-28 mb-56">
          <div className="px-2">
            <img
              src={assets_25to32.candyworldmatch3mania}
              alt="game"
              className="w-[200px] m-auto mb-2"
            />
            <h1 className="text-center text-[#fff] text-2xl">
            Candy World : match3 mania
            </h1>
            <Link to="https://thalagames.com/game/candy-world-match3-mania/play">
              <div
