...
export default function Gameloftsportsminigame() {
    ...
    <div>
      <div className="bg-[#010127]">
        ...
        <div className="w-[380px] mx-auto mt-28 mb-56">
          <div className="px-2">
            <img
              src={assets_1to8.gameloftsportsminigame}
              alt="game"
              className="w-[200px] m-auto mb-2"
            />
            <h1 className="text-center text-[#fff] text-2xl">
            Gameloft Sports Minigame
            </h1>
            <Link to="https://thalagames.com/game/gameloft-sports-minigame/play">
              <div
